...
<div ng-app="app" ng-controller="CityController">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select ng-model="model.countryId" class="bootstrap-select" data-live-search="true" data-width="100%">
                                <option ng-repeat="item in list" value="item.countryId">{{item.countryId}}</option>
                        </select>
                    </div>

                    <h6 class="text-semibold">City Name</h6>
...
<script src="resources/js/plugins/forms/selects/bootstrap_select.min.js"></script>

<script src="resources/js/core/app.js"></script>
<script src="resources/js/pages/form_bootstrap_select.js"></script>
...
<script src="resources/angular/city.js"></script>